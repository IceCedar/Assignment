...
editor: visual
---
GitHub link: [View the assignment on GitHub](https://github.com/IceCedar/Assignment)
...
```{r}
averageTotal<-sapply(winedf,mean)
averageClass1<-sapply(winedf[winedf$Class==1,],mean)
averageClass2<-sapply(winedf[winedf$Class==2,],mean)
averageClass3<-sapply(winedf[winedf$Class==3,],mean)
